        ...
        e(document).ready(function () {
            function t() {
                ...
                e(".slides-container li").removeClass("active-slide"),
                    ...
                    e(".slides-container li.bg-dark").hasClass("active-slide") ? (o.addClass("header-light"), e(".module-slides").removeClass("dark-nav")) : (o.removeClass("header-light"), e(".module-slides").addClass("dark-nav"));
            }
            function a() {
            ...
            e(window)
                .scroll(function () {
                    ...
                    t >= 20 ? (o.addClass("header-small"), o.addClass("header-shadow")) : (o.removeClass("header-small"), o.removeClass("header-shadow")),
                        e(".module-header").length <= 0 && e(".module-slides").length <= 0 && e(".flexslider").length <= 0 && o.addClass("header-small");
                })
                .scroll();
            var n = e(".module-header");
            n.length >= 0 && (n.hasClass("bg-dark") ? o.addClass("header-light") : o.removeClass("header-light")),
            ...
            e("a", r).on("click", function () {
                ...
                e(window)
                    .on("resize", function () {
                        l.imagesLoaded(function () {
                            l.isotope({ layoutMode: "masonry", itemSelector: ".portfolio-item, .portfolio-item-classic ", transitionDuration: "0.4s", masonry: { columnWidth: ".grid-sizer" } });
                        });
                    })
                    .resize(),
                ...
                e(".map").each(function () {
                    ...
                    if (a.length > 0) {
                        var s,
                            o = a[0].getAttribute("data-addresses").match(t),
                                    ...
                                    events: {
                                        click: function (t, a, i) {
                                            if (i.data) {
                                                ...
                                                o ? (o.open(s, t), o.setContent(i.data)) : e(this).gmap3({ infowindow: { anchor: t, options: { content: i.data } } });
                                            }
                                        },
                                    },
                                },
                ...
                particlesJS("particles-js", {
                    particles: {
                        number: { value: 60, density: { enable: !0, value_area: 900 } },
                        color: { value: "#ffffff" },
                        shape: { type: "circle", stroke: { width: 0, color: "#ffffff" }, polygon: { nb_sides: 5 }, image: { src: "img/github.svg", width: 100, height: 100 } },
                        opacity: { value: 0.3, random: !0, anim: { enable: !0, speed: 1, opacity_min: 0.1, sync: !1 } },
                        ...
                        move: { enable: !0, speed: 1, direction: "top", random: !0, straight: !1, out_mode: "out", bounce: !1, attract: { enable: !0, rotateX: 600, rotateY: 1200 } },
                    },
                    interactivity: {
                        detect_on: "canvas",
                ...
                e("#particles-snow-js").length > 0 &&
                particlesJS("particles-snow-js", {
                    particles: {
                        number: { value: 400, density: { enable: !0, value_area: 800 } },
                        color: { value: "#fff" },
                        shape: { type: "circle", stroke: { width: 0, color: "#000000" }, polygon: { nb_sides: 5 }, image: { src: "img/github.svg", width: 100, height: 100 } },
                        opacity: { value: 0.5, random: !0, anim: { enable: !1, speed: 1, opacity_min: 0.1, sync: !1 } },
                        size: { value: 7, random: !0, anim: { enable: !1, speed: 40, size_min: 0.1, sync: !1 } },
                        line_linked: { enable: !1, distance: 500, color: "#ffffff", opacity: 0.4, width: 2 },
                        move: { enable: !0, speed: 6, direction: "bottom", random: !1, straight: !1, out_mode: "out", bounce: !1, attract: { enable: !1, rotateX: 600, rotateY: 1200 } },
                    },
                    interactivity: {
                        detect_on: "canvas",
                ...
                e(".smoothscroll").on("click", function (t) {
                    ...
                    e("html, body")
                        .stop()
                        .animate({ scrollTop: i.offset().top - o.height() }, 600, "swing"),
                        t.preventDefault();
                }),
