...
namespace MVCWebApplication.DbContexts
{
    public static class SeedDbContext
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            var products = SeedProducts(modelBuilder);
            SeedOrders(modelBuilder);
            var orderItems = SeedOrderItems(modelBuilder, products);
            SeedPayments(modelBuilder, orderItems);
        }
        ...
        private static List<Product> SeedProducts(ModelBuilder modelBuilder)
        {
            ...
            {
                new Product{IdProduct=-1, Name="iPhone 13",Type="Smartphone",Price=699,Description="Cutting-edge Apple phone with A15 Bionic chip, dual-camera system, and stunning Super Retina XDR display."},
                ...
                new Product{IdProduct = -3, Name="iPad Air",Type="Tablet",Price=499,Description="Powerful and portable tablet featuring the A14 Bionic chip, 10.9-inch Liquid Retina display, and support for the Apple Pencil."},
                new Product{IdProduct=-4,Name="Canon EOS M50",Type="Digital Camera",Price=649,Description="Mirrorless camera with 4K video, Dual Pixel CMOS AF, and a vari-angle touchscreen for creative photography and videography."},
                ...
                new Product{IdProduct=-6,Name="Lenovo ThinkPad X1 Carbon",Type="Laptop",Price=1299,Description="Business-class ultrabook known for its durability, excellent keyboard, and robust performance, providing professionals with a reliable computing solution."},
                new Product{IdProduct=-7,Name="Microsoft Surface Pro 7",Type="Tablet",Price=799,Description="Versatile 2-in-1 tablet/laptop hybrid featuring a detachable keyboard, powerful processors, and a high-resolution PixelSense display, ideal for work and creativity."},
                new Product{IdProduct=-8,Name="Canon EOS Rebel T7i ",Type="Digital Camera",Price=699,Description="Entry-level DSLR camera with a 24.2MP sensor, DIGIC 7 processor, and Dual Pixel CMOS AF for capturing high-quality photos and Full HD videos, perfect for photography enthusiasts."},
                new Product{IdProduct=-9,Name="Nokia 6",Type="Smartphone",Price=300,Description="The Nokia 6, a budget-friendly Android smartphone, offers a sturdy build, a 5.5-inch Full HD display, and efficient performance with its Snapdragon processor."},
            });
        ...
        {
            new Order {IdOrder = -1,DateTime = DateTime.Now.AddDays(1).AddMinutes(1),Status = 1,UserId = -1},
            new Order {IdOrder = -2,DateTime = DateTime.Now.AddDays(1).AddMinutes(2),Status = 1,UserId = -2},
            new Order {IdOrder = -3,DateTime = DateTime.Now.AddDays(1).AddMinutes(3),Status = 1,UserId = -3},
            new Order {IdOrder = -4,DateTime = DateTime.Now.AddDays(1).AddMinutes(4),Status = 1,UserId = -4},
            new Order {IdOrder = -5,DateTime = DateTime.Now.AddDays(1).AddMinutes(5),Status = 1,UserId = -5},
            new Order {IdOrder = -6,DateTime = DateTime.Now.AddDays(1).AddMinutes(6),Status = 1,UserId = -6},
            new Order {IdOrder = -7,DateTime = DateTime.Now.AddDays(1).AddMinutes(7),Status = 1,UserId = -7},
            new Order {IdOrder = -8,DateTime = DateTime.Now.AddDays(1).AddMinutes(8),Status = 1,UserId = -8},
            new Order {IdOrder = -9,DateTime = DateTime.Now.AddDays(1).AddMinutes(9),Status = 1,UserId = -9},
            new Order {IdOrder = -10,DateTime = DateTime.Now.AddDays(1).AddMinutes(10),Status = 1,UserId = -10},
            new Order {IdOrder = -11,DateTime = DateTime.Now.AddDays(2).AddMinutes(1),Status = 2,UserId = -11},
            new Order {IdOrder = -12,DateTime = DateTime.Now.AddDays(2).AddMinutes(2),Status = 2,UserId = -12},
            new Order {IdOrder = -13,DateTime = DateTime.Now.AddDays(2).AddMinutes(3),Status = 2,UserId = -1},
            new Order {IdOrder = -14,DateTime = DateTime.Now.AddDays(2).AddMinutes(4),Status = 2,UserId = -2},
            new Order {IdOrder = -15,DateTime = DateTime.Now.AddDays(2).AddMinutes(5),Status = 2,UserId = -3},
            new Order {IdOrder = -16,DateTime = DateTime.Now.AddDays(2).AddMinutes(6),Status = 2,UserId = -4},
            new Order {IdOrder = -17,DateTime = DateTime.Now.AddDays(2).AddMinutes(7),Status = 2,UserId = -5},
            new Order {IdOrder = -18,DateTime = DateTime.Now.AddDays(2).AddMinutes(8),Status = 2,UserId = -6},
            new Order {IdOrder = -19,DateTime = DateTime.Now.AddDays(2).AddMinutes(9),Status = 2,UserId = -7},
            new Order {IdOrder = -20,DateTime = DateTime.Now.AddDays(2).AddMinutes(10),Status = 2,UserId = -8},
        });
            modelBuilder.Entity<Order>().HasData(orders);
        }
        private static List<OrderItem> SeedOrderItems(ModelBuilder modelBuilder, List<Product> products)
        {
        ...
        private static void SeedPayments(ModelBuilder modelBuilder, List<OrderItem> orderItems)
        {
            var payments = new List<Payment>
        {
            new Payment{IdPayment = -1,BankAccountNumber = "CZ81 5889 0000 4643 3473 5252",         DateTime = DateTime.Now.AddDays(1).AddHours(1).AddMinutes(1),Value = orderItems.Where(t=>t.OrderId==-1).Sum(t => t.Price),OrderId = -1},
            new Payment{IdPayment = -2,BankAccountNumber = "HR24 0874 9806 5762 1181 6",            DateTime = DateTime.Now.AddDays(1).AddHours(1).AddMinutes(2),Value = orderItems.Where(t=>t.OrderId==-2).Sum(t => t.Price),OrderId = -2},
            new Payment{IdPayment = -3,BankAccountNumber = "AL37 9846 8374 WUD8 JZGT LVMN JCOW",    DateTime = DateTime.Now.AddDays(1).AddHours(1).AddMinutes(3),Value = orderItems.Where(t=>t.OrderId==-3).Sum(t => t.Price),OrderId = -3},
            new Payment{IdPayment = -4,BankAccountNumber = "DO40 72LI 0452 9323 7721 7730 7647",    DateTime = DateTime.Now.AddDays(1).AddHours(1).AddMinutes(4),Value = orderItems.Where(t=>t.OrderId==-4).Sum(t => t.Price),OrderId = -4},
            new Payment{IdPayment = -5,BankAccountNumber = "SA94 83LU 2BLO NBCS WSVT LAZP",         DateTime = DateTime.Now.AddDays(1).AddHours(1).AddMinutes(5),Value = orderItems.Where(t=>t.OrderId==-5).Sum(t => t.Price),OrderId = -5},
            new Payment{IdPayment = -6,BankAccountNumber = "IS07 9401 7783 5946 2967 7237 65",      DateTime = DateTime.Now.AddDays(1).AddHours(1).AddMinutes(6),Value = orderItems.Where(t=>t.OrderId==-6).Sum(t => t.Price),OrderId = -6},
            new Payment{IdPayment = -7,BankAccountNumber = "IS10 1020 8272 3613 7283 5610 19",      DateTime = DateTime.Now.AddDays(1).AddHours(1).AddMinutes(7),Value = orderItems.Where(t=>t.OrderId==-7).Sum(t => t.Price),OrderId = -7},
            new Payment{IdPayment = -8,BankAccountNumber = "FR62 8976 4864 50GL 8ABI JVWY L60",     DateTime = DateTime.Now.AddDays(1).AddHours(1).AddMinutes(8),Value = orderItems.Where(t=>t.OrderId==-8).Sum(t => t.Price),OrderId = -8},
            new Payment{IdPayment = -9,BankAccountNumber = "BR93 5424 5107 5566 4290 2950 450F O",  DateTime = DateTime.Now.AddDays(1).AddHours(1).AddMinutes(9),Value = orderItems.Where(t=>t.OrderId==-9).Sum(t => t.Price),OrderId = -9},
            new Payment{IdPayment = -10,BankAccountNumber = "MR88 5504 2625 3138 4613 3045 666",    DateTime = DateTime.Now.AddDays(1).AddHours(1).AddMinutes(10),Value = orderItems.Where(t=>t.OrderId==-10).Sum(t => t.Price),OrderId = -10},
            new Payment{IdPayment = -11,BankAccountNumber = "KW69 RTQQ HVJI XCHJ YD5G SCZI 9M3F AT",DateTime = DateTime.Now.AddDays(2).AddHours(1).AddMinutes(1),Value = orderItems.Where(t=>t.OrderId==-11).Sum(t => t.Price),OrderId = -11},
            new Payment{IdPayment = -12,BankAccountNumber = "FR04 1021 2432 41T2 YTFH 3ITC J99",    DateTime = DateTime.Now.AddDays(2).AddHours(1).AddMinutes(2),Value = orderItems.Where(t=>t.OrderId==-12).Sum(t => t.Price),OrderId = -12},
            new Payment{IdPayment = -13,BankAccountNumber = "CZ81 5889 0000 4643 3473 5252",        DateTime = DateTime.Now.AddDays(2).AddHours(1).AddMinutes(3),Value = orderItems.Where(t=>t.OrderId==-13).Sum(t => t.Price),OrderId = -13},
            new Payment{IdPayment = -14,BankAccountNumber = "HR24 0874 9806 5762 1181 6",           DateTime = DateTime.Now.AddDays(2).AddHours(1).AddMinutes(4),Value = orderItems.Where(t=>t.OrderId==-14).Sum(t => t.Price),OrderId = -14},
            new Payment{IdPayment = -15,BankAccountNumber = "AL37 9846 8374 WUD8 JZGT LVMN JCOW",   DateTime = DateTime.Now.AddDays(2).AddHours(1).AddMinutes(5),Value = orderItems.Where(t=>t.OrderId==-15).Sum(t => t.Price),OrderId = -15},
            new Payment{IdPayment = -16,BankAccountNumber = "DO40 72LI 0452 9323 7721 7730 7647",   DateTime = DateTime.Now.AddDays(2).AddHours(1).AddMinutes(6),Value = orderItems.Where(t=>t.OrderId==-16).Sum(t => t.Price),OrderId = -16},
            new Payment{IdPayment = -17,BankAccountNumber = "SA94 83LU 2BLO NBCS WSVT LAZP",        DateTime = DateTime.Now.AddDays(2).AddHours(1).AddMinutes(7),Value = orderItems.Where(t=>t.OrderId==-17).Sum(t => t.Price),OrderId = -17},
            new Payment{IdPayment = -18,BankAccountNumber = "IS07 9401 7783 5946 2967 7237 65",     DateTime = DateTime.Now.AddDays(2).AddHours(1).AddMinutes(8),Value = orderItems.Where(t=>t.OrderId==-18).Sum(t => t.Price),OrderId = -18},
            new Payment{IdPayment = -19,BankAccountNumber = "IS10 1020 8272 3613 7283 5610 19",     DateTime = DateTime.Now.AddDays(2).AddHours(1).AddMinutes(9),Value = orderItems.Where(t=>t.OrderId==-19).Sum(t => t.Price),OrderId = -19},
            new Payment{IdPayment = -20,BankAccountNumber = "FR62 8976 4864 50GL 8ABI JVWY L60",    DateTime = DateTime.Now.AddDays(2).AddHours(1).AddMinutes(10),Value = orderItems.Where(t=>t.OrderId==-20).Sum(t => t.Price),OrderId = -20}
        };
